class Reading {
  ...
  /// Acepta el formato anterior de un sensor y el nuevo perfil de 100 cm:
  ///
  /// {
  ///   "ts": "2026-08-19T14:30:00Z",
  ///   "humidityByDepth": {"10": 34.1, ..., "100": 42.0},
  ///   "temperature30C": 18.2,
  ///   "temperature70C": 16.7,
  ///   "batteryPercent": 72
  /// }
  factory Reading.fromJsonMap(Map<String, dynamic> json) {
    ...
    return Reading(
      ...
      humidity: primaryHumidity ?? average,
  ...
  static Map<int, double> _profileFrom(Map<String, dynamic> json) {
    ...
    // Compatibilidad con payload plano: h10, h20 ... h100.
